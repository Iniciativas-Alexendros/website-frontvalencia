...
const text = {
  es: {
    ...
    description: 'Utilizamos cookies para mejorar tu experiencia y analizar el tráfico. Puedes elegir qué cookies aceptar.',
  ...
  en: {
    title: 'Cookie Usage',
    description: 'We use cookies to improve your experience and analyse traffic. You can choose which cookies to accept.',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start gap-3 flex-1">
            <div className="text-terracotta-400 mt-0.5 shrink-0" aria-hidden="true">{t.icon}</div>
            <div>
